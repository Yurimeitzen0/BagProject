...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AAIS_CPP_StatItem_Statics::NewProp_StatRestore = { UE4CodeGen_Private::EPropertyClass::Array, "StatRestore", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(AAIS_CPP_StatItem, StatRestore), METADATA_PARAMS(Z_Construct_UClass_AAIS_CPP_StatItem_Statics::NewProp_StatRestore_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAIS_CPP_StatItem_Statics::NewProp_StatRestore_MetaData)) };
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAIS_CPP_StatItem_Statics::NewProp_PrimaryStatIndex_MetaData[] = {
		{ "Category", "Stat" },
		{ "ExposeOnSpawn", "true" },
		{ "ModuleRelativePath", "AIS_CPP_StatItem.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AAIS_CPP_StatItem_Statics::NewProp_PrimaryStatIndex = { UE4CodeGen_Private::EPropertyClass::Int, "PrimaryStatIndex", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0011000000000005, 1, nullptr, STRUCT_OFFSET(AAIS_CPP_StatItem, PrimaryStatIndex), METADATA_PARAMS(Z_Construct_UClass_AAIS_CPP_StatItem_Statics::NewProp_PrimaryStatIndex_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAIS_CPP_StatItem_Statics::NewProp_PrimaryStatIndex_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAIS_CPP_StatItem_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAIS_CPP_StatItem_Statics::NewProp_PrimaryStatIndex,
	};
	...
	IMPLEMENT_CLASS(AAIS_CPP_StatItem, 1152594254);
